 ...
 */
std::string bitsToBytes(std::string text);
 ...
 */
std::string bytesToBits(std::string text);
 ...
 */
void printBits(std::string text);
 ...
 */
std::string toPrintableChar(int ch);
